...
private static void PermutationsChooseHelper(List<string> results, string letters, string prefix, int size)
{
    if (size == 0)
    {
        results.Add(prefix);
    ...
    {
        PermutationsChooseHelper(results, letters.Substring(0, i) + letters.Substring(i + 1), prefix + letters[i], size - 1);
    }
}
